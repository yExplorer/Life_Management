...
(function () {
    ...
    g.Events = {on:function (a, b, c) {
        ...
        e = d.all;
        for ((a = a.split(/\s+/)).push(null); b = a.shift();)e && a.push({next:e.next, tail:e.tail,
            event:b}), (c = d[b]) && a.push({next:c.next, tail:c.tail});
    ...
    f.extend(g.Model.prototype, g.Events, {idAttribute:"id", initialize:function () {
    }, toJSON:function () {
    ...
    f.extend(g.Collection.prototype, g.Events, {model:g.Model, initialize:function () {
    },
        toJSON:function () {
    ...
    f.extend(g.Router.prototype, g.Events, {initialize:function () {
    ...
    var m = /^[#\/]/, x = /msie [\w.]+/, l = !1;
    f.extend(g.History.prototype, g.Events, {interval:50, getFragment:function (a, b) {
    ...
    f.extend(g.View.prototype, g.Events, {tagName:"div", $:function (a) {
